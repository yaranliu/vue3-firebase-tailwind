...
<!--    Google-->
    <div class="provider-button" @click="signInWithGoogle">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512" fill="gray">
...
<!--    Twitter-->
    <div class="provider-button">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="gray">
...
<!--    Github-->
    <div class="provider-button">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" fill="gray">
