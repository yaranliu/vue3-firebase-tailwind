...
<template>
  <div class="auth-card">
    ...
    <input id="user-email" type="text" placeholder="E-mail" v-model.trim="user.email" class="auth-input" v-focus>
    <label for="user-password" class="auth-input-label mt-6">Password</label>
    <input id="user-password" type="password" placeholder="Password" v-model.trim="user.password" class="auth-input" >
    <label for="user-confirm" class="auth-input-label mt-6">Confirm password</label>
    <input id="user-confirm" type="password" placeholder="Password" v-model.trim="user.passwordConfirmation" class="auth-input" >
    <button @click="register" class="auth-primary-button mt-6">
      Sign up
    </button>
